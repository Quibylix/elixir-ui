    ...
    <nav className={styles.navbar}>
      <div className={styles.wrapper}>
        ...
        <ul className={styles.links}>
          <li>
            <Link color="primary" as={I18nLink} href="/docs">
              {dict.navbar.links.docs}
            </Link>
          </li>
          <li>
            <Link color="primary" as={I18nLink} href="/components">
              {dict.navbar.links.components}
            </Link>
          </li>
          <li>
            <Link color="primary" as={I18nLink} href="/themes">
              {dict.navbar.links.about}
            </Link>
          </li>
          <li>
            <Link color="primary" as={I18nLink} href="/blog">
              {dict.navbar.links.blog}
            </Link>
          </li>
        </ul>
        <div className={styles.actions}>
          <LanguagePicker currentLanguage={LanguageContext.lang} />
          <I18nLink
